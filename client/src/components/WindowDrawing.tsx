        ...
        return (
          <>
            ...
            <rect 
              ...
              width={svgWidth - (frameInset * 2) + 2} 
              height={svgHeight - frameInset - (svgHeight / 3) - mullionThickness - 50 + 1} 
              fill="none" 
              className="window-casement" 
            />
            ...
            <rect 
              ...
              width={svgWidth - ((frameInset + innerBorderWidth) * 2)} 
              height={svgHeight - frameInset - (svgHeight / 3) - mullionThickness - 50 - innerBorderWidth - innerBorderWidth} 
              className="window-casement-interior"
            />
        ...
        return (
          <>
            ...
            <rect 
              ...
              y={frameInset + (svgHeight / 3) + mullionThickness + innerBorderWidth} 
              width={(svgWidth / 2) - frameInset - (mullionThickness / 2) - (innerBorderWidth * 2)} 
              height={svgHeight - frameInset - (svgHeight / 3) - mullionThickness - 50 - (innerBorderWidth * 2)} 
              className="window-casement-interior"
            />
